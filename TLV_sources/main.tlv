...
\SV
   ...
   m4_include_lib(['https://raw.githubusercontent.com/Eper00/Toy-Tensor-Processing-Unit-TTPU-/TLV_sources/floating_point_multiplayer.tlv'])
   m4_lab()
...
\TLV
   /board
      ...
      // Full adder példányosítása
      m5+full_adder($out, $carry_out, $in1, $in2, $carry_in)
